...
bot = telebot.TeleBot('7716572295:AAFT2xqv3JdI-fATd_QiGtJxH2LqVnDQB_k')
...
def welcome_start(message):
    ...
    response = f'''🔥ROXZ ke LODE pe aapka swagat hai, {user_name}! Sabse acche se bgmi ki maa behen yahi hack karta hai. Kharidne ke liye Kira se sampark karein.
